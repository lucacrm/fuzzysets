...
\begin{figure}[!h]
        ...
        \subfigure[A ogni valore $x \in \Omega$ corrisponde un piano i cui assi sono $u$ e $\mu_A(x,u)$. In evidenza il piano corrispondente a $x_1$\label{fuzzy12}]%
...
\begin{figure}[H]
        \centering%
        \subfigure[Fuzzificazione crisp.\label{fuzzification16}]%
          {\includegraphics[scale=.4]{figure/fuzzification16.pdf}}\qquad\qquad
       ...
       \subfigure[Fuzzificazione lineare a tratti, decrescente a ogni quartile.\label{fuzzification14}]%
          {\includegraphics[scale=.4]{figure/fuzzification14.pdf}}\qquad\qquad
           \subfigure[Fuzzificazione esponenziale con $\alpha$ vicino a zero.\label{fuzzification15}]%
          {\includegraphics[scale=.4]{figure/fuzzification15.pdf}}\qquad\qquad
           \subfigure[Fuzzificazione esponenziale con $\alpha$ vicino a uno.\label{fuzzification17}]%
          {\includegraphics[scale=.4]{figure/fuzzification17.pdf}}
          \caption{Diversi esempi di fuzzificazione\label{fuzzificatori}.}
\end{figure}
\section{Costruire la funzione di appartenenza in assenza di membership: esempio con un benchmark}
\chaptermark{Esempio con un benchmark}
...
\chaptermark{Apprendimento simultaneo}
...
\begin{figure}[!tb]
        \centering%
        \subfigure[setosa]%
          {\includegraphics[scale=.35, angle=90]{figure/setosabmu.pdf}}\qquad\qquad
       \subfigure[versicolor\label{versbmu}]%
          {\includegraphics[scale=.35, angle=90]{figure/versicolorbmu.pdf}}\qquad\qquad
           \subfigure[virginica\label{virbmu}]%
          {\includegraphics[scale=.35, angle= 90]{figure/virginicabmu.pdf}}
...
\begin{figure}[H]
        \centering%
        \subfigure[$\alpha = 0.8$.\label{expsetosa8}]%
          {\includegraphics[scale=.4, angle=90]{figure/expsetosa8.pdf}}\qquad\qquad
       \subfigure[$\alpha = 0.6$.\label{expsetosa6}]%
          {\includegraphics[scale=.4, angle=90]{figure/expsetosa6.pdf}}\qquad\qquad
           \subfigure[$\alpha = 0.4.$\label{expsetosa4}]%
          {\includegraphics[scale=.4, angle=90]{figure/expsetosa4.pdf}}\qquad\qquad
           \subfigure[$\alpha = 0.2.$\label{expsetosa2}]%
          {\includegraphics[scale=.4, angle=90]{figure/expsetosa2.pdf}}
